                    ...
                    <div class="page-title-box">
                        <div class="page-title-right float-left">
                            <ol class="breadcrumb m-0"> 
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Ledger Report</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-primary" :disabled="disabled" @click="filterLedgerReport()">
                                ...
                                <table class="table table-bordered table-centered w-100" v-if="!loading">
                                    ...
                                    <tbody >
                                        ...
                                        <!-- <template v-for="(item, i) in items" :key="i">
                                            <template v-if="item.recursion.length > 0"> -->
                                                <!-- <tr v-for="(ledger, j) in item.recursion" :key="j"> -->
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right">{{ row_available_balance.toFixed(4) }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                    ...
                    <Modal @close="toggleModal()"  >
                        <div class="modal-content scrollbar-width-thin orderPreview" >
                            <div class="modal-header"> 
                                ...
                                <h3 style="width: 100%">Ledger Report</h3>
                            </div>
                                    ...
                                    <table class="table po_invoice">
                                        <tr>
                                            <td colspan="2" class="text-center" style="position: relative;">
                                                ...
                                                <h4 style="text-align: center;">Ledger Report</h4>
                                    ...
                                    <table class="table table-bordered table-centered w-100" v-if="!loading">
                                        ...
                                        <tbody >
                                            ...
                                            <tr v-for="(ledger, index) in newItemAry" :key="index">
                                                ...
                                                <td class="text-center">{{ ledger.vdate }}</td>
                                                <td class="text-center">{{ ledger.voucher_code }}</td>
                                                <td class="text-left" style="word-wrap: break-word; max-width: 400px !important;">{{ ledger.ledger_details }}</td>
                                                <!-- <td>{{ ledger.global_note }}</td>  -->
                                                <td class="text-right" v-if="ledger.pvaccount_type == 'dr'">{{ ledger.credit }}</td>
                                                <td class="text-right" v-else> --- </td>
                                                <td class="text-right" v-if="ledger.pvaccount_type == 'cr'">{{ ledger.debit }}</td>
...
export default {
    ...
    methods: { 
        ...
        fetchLedgerReport() { 
            ...
            axios.post(this.apiUrl+'/reports/ledger-report', data, this.headerjson)
            .then((res) => {
                console.log("report_data", res.data.data.report_data);
        ...
        {
            // if(this.search_terms.ledger_id) {
            //     this.disabled = false;
            // }else{
            //     this.disabled = true;
            // }
