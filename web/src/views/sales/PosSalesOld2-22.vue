            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="">
                                        ...
                                        <select class="form-control" id="outlet_id" v-model="tableData.outlet_id" @change="onkeyPress('outlet_id')">
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="">
                                        ...
                                        <Multiselect
                                            ...
                                            @change="onChangeProduct($event), onkeyPress('product_id')"
                                            :searchable="true"
                                            :filter-results="true"
                        ...
                        <div class="col-md-2">
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary" :disabled="disabled" @click="filterSaleData()">
              ...
              <div class="card">  
                  <div class="card-body"> 
                     <Datatable 
                        ...
                        <template #body v-if="items.length > 0">   
                            <tbody v-for="(item, i) in items" :key="i">
                                <tr v-for="(sale_item, j) in item.sales_items" :key="j" class="bordered">
                                  <td :rowspan="item.sales_items_count" v-if="j==0" class="text-center">{{ item.id }} </td> 
                                  <td :rowspan="item.sales_items_count" v-if="j==0">{{ item.created_at }}</td>
                                  <td :rowspan="item.sales_items_count" v-if="j==0">{{ item.invoice_number }} </td>
                                  <td :rowspan="item.sales_items_count" v-if="j==0">{{ item.outlets ? item.outlets.name : 'N/A' }} </td>
                                  <td :rowspan="item.sales_items_count" v-if="j==0">{{ item.customer_name }} </td>
                                  <td>{{ sale_item.products.product_name }} </td>
                                  <td class="text-center">{{ Number(sale_item.quantity) }} </td>
                                  <td class="text-center">{{ Number(sale_item.weight) }} </td>
                                  <td class="text-right">{{ Number(sale_item.mrp_price) }} </td>
                                  <td class="text-right">
                                    {{
                                      sale_item.uom == 5
                                      ? parseFloat(
                                          sale_item.mrp_price * sale_item.weight - sale_item.discount
                                        ).toFixed(2)
                                      : parseFloat(
                                          sale_item.mrp_price * sale_item.quantity - sale_item.discount
                                        ).toFixed(2)
                                    }} 
                                </td>
                                  <!-- <td class="text-right" :rowspan="item.sales_items_count" v-if="j==0">{{ item.total_amount }}</td>  -->
                                  <td class="text-right" :rowspan="item.sales_items_count" v-if="j==0">{{ item.grand_total }}</td> 
                                  <td class="text-right" :rowspan="item.sales_items_count" v-if="j==0">{{ item.collection_amount }}</td>
                                  <td :rowspan="item.sales_items_count" v-if="j==0">
...
export default {
  ...
  methods: { 
      ...
      {
          if((this.tableData.from_date != '' && this.tableData.to_date != '') || this.tableData.outlet_id != '') {
              this.disabled = false;
          }else{
              this.disabled = true;
          }
