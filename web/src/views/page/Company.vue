                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <div class="page-title-right float-right ">
                            <button type="button" class="btn btn-primary float-right" @click="toggleModal" v-if="permission['company-create']">
                                Add New
                            </button>
                        </div>
                    </div>
                            ...
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100"
                                ...
                                <tbody v-if="items.length > 0">
                                    <tr class="border" v-for="(item, i) in items" :key="i">
                                        ...
                                        <td>
                                            <a href="#" @click="edit(item)" v-if="permission['company-edit']"><i class="fas fa-edit"></i> </a>
                                            <a href="#" @click="deleteItem(item)" v-if="permission['company-delete']"><i class="fas fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
