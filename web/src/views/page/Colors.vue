                    ...
                    <div class="page-title-box">
                        <div class="page-title-right float-left">
                            <ol class="breadcrumb m-0"> 
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Color List</a></li>
                                            ...
                                            <td>
                                                <div class="dropdown float-end">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end"> 
                                                        <a href="javascript:void(0);" class="dropdown-item text-warning" @click="edit(item)" v-if="permission['color-edit']">
                                                        <i class="mdi mdi-circle-edit-outline me-1"></i>Edit</a> 
                                                        <a href="javascript:void(0);" class="dropdown-item text-danger" @click="deleteItem(item)" v-if="permission['color-delete']" ><i class="mdi mdi-delete-outline me-1"></i>Remove</a>
                                                    </div>
                                                </div> 
                                            </td> 
                                        </tr>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group  ">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control border " @keypress="onkeyPress('name')" v-model="form.name" id="name" placeholder="Color name" autocomplete="off"> 
                                    ...
                                    <div class="form-group  ">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control border " @keypress="onkeyPress('code')" v-model="form.code" id="code" placeholder="Color code" autocomplete="off"> 
    ...
    methods: {
        ...
        submitForm: function(e) { 
            ...
            if(this.editMode){
                ...
                var postEvent = axios.post(this.apiUrl+'/colors/'+this.form.id, formData, this.headers);
            }else{  
                var postEvent = axios.post(this.apiUrl+'/colors', formData, this.headers);
            }     
            ...
            postEvent.then(res => {                
                ...
                if(res.status == 200){
                    this.toggleModal();
                    this.fetchData(this.apiUrl+'/colors?page='+this.pagination.currentPage);
        ...
        deleteItem: function(item) {
            ...
            this.$swal({
                ...
                if (result.value) { 
                    axios.delete(this.apiUrl+'/colors/'+item.id, this.headerjson)
                    .then(res => {
                        if(res.status == 200){ 
                            this.fetchData(this.apiUrl+'/colors?page='+this.pagination.currentPage);
                            this.$toast.success(res.data.message); 
