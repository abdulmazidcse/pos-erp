...
<template>
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right float-left">
                        <ol class="breadcrumb m-0"> 
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Store Requistion Purchase Order</a></li>
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="card">
                    <div class="tab-pane show active" v-if="loading" style="margin-top: 50px;">
                        <div class="row"> 
                            <div class="col-md-5">  
                            </div>
                            <div class=" col-md-2"> 
...
export default {
    ...
    created() {
        ...
        this.fetchStoreRequisition(this.requisitionId);

    },
    methods: { 

        fetchStoreRequisition(requisition_id) {
            axios.get(this.apiUrl+'/store_requisitions/'+requisition_id+'/storeRequisitionPurchaseOrder', this.headers)
            .then((res) => {
        ...
        submitForm: function(e) {  
            ...
            var postEvent = axios.post(this.apiUrl+'/store_requisitions/'+this.requisitionId+'/confirmPurchaseOrder', formData, this.headers);
