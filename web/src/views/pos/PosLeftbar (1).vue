<template>
  <div class="row">
    <div class="col-sm-12 col-md-8">
      <div class="pos-leftbar" id="pos-leftbar">
        <div class="pos-header">
          <div class="mb-1">
            <div class="row">
              <div v-if="form.customer_id == 1" class="col-md-4">
                <div class="form-group">
                  <input
                    type="text"
                    v-model="form.default_customer_name"
                    class="form-control"
                    placeholder="Customer's Name"
                  />
                </div>
              </div>
              <div :class="(form.customer_id == 1) ? 'col-md-8' : 'col-md-12'">
            ...
            >
              <thead class="tableFloatingHeaderOriginal">
                <tr class="border item-head">
                  ...
                  <th width="10%" class="text-center">Disc %
                    <input
                      class="form-control discount_percent"
                      v-model="items_discount_percent"
                      type="number"
                      @change="allItemDiscountPercent()"
              ...
              <tr class="border">
                ...
                <td class="text-center border">{{parseFloat(totalItemPrice).toFixed(2)}}</td>  
                <td class="text-center border">{{parseFloat(totalItemValue).toFixed(2)}}</td>
                <td class="text-center border"></td>
                <td class="text-center border"></td>
                <td class="text-center border">{{parseFloat(totalItemDiscountValue).toFixed(2)}}</td>
                <td class="text-center border">{{parseFloat(totalItemNetValue).toFixed(2)}}</td>
    ...
    <div class="col-sm-12 col-md-4">
      <!-- <div class="row">
          <div class="form-group col-md-12">
              <label for="cost_center_id" style="width: 100%;">Cost Centers *</label>
              <treeselect 
        ...
        <div>
          ...
          >
            <thead class="tableFloatingHeaderOriginal">
              ...
              <tr class="border item-head">
                <th>Total</th>
                <th>{{ Number(Math.abs(totalCartValue)).toLocaleString() }}</th> 
              </tr>
              <tr class="item-head">
            ...
            <div id="mid">
              <div class="info">
                <p class="text-left" style="font-size: 14px">
                  Name: {{ returnInfo.customer_name }}<br />
              ...
              <div id="table">
                <table>
                  ...
                  <!-- <tr class="return-replace-summary">
                    <td colspan="5"></td>
                    <td class="Rate" colspan="2">
                      <h2>Cost Center dfsdf:</h2>
                    </td>
                    <td class="payment">
                      <treeselect 
                        v-model="sale_return_info.cost_center_id"
                        :multiple="false" 
                        :always-open="false"
                        :options="costCenterOptions"
                        :value-consists-of="valueConsistsOf"
      ...
      <div class="modal-content scrollbar-width-thin confirm-window">
        ...
        <div class="modal-body inv-perview" v-if="cartItems.length > 0">
          <div id="invoice-perview">
            <div id="top">
              <div class="row">
                <h2 class="text-center" style="font-size: 18px">{{this.retailShopName}}</h2>
                <h5 class="text-center" style="font-size: 14px"> {{ this.retailSmallText }}</h5>
              ...
              <div id="table">
                <table >
                  ...
                  <tr class="service " >   
                    ...
                    <td class="text-right"><h2>{{parseFloat(totalItemDiscountValue).toFixed(2)}} </h2></td>
                    <td class="text-right"><h2>{{parseFloat(totalItemNetValue).toFixed(2)}} </h2></td> 
                  </tr>
                  <tr v-if="totalCartValue" class="service">
                    ...
                    <td class="Rate" colspan="2"><h2>Total Amount</h2></td>
                    <td class="payment">
                      <h2 class="text-right">{{ Number(totalCartValue).toFixed(2) }}</h2>
                    </td>
                  </tr>
                  <tr class="service">
                    <td></td>
                  ...
                  <tr v-if="totalCartTax" class="service">
                    ...
                    <td class="Rate" colspan="2"><h2>VAT</h2></td>
                    <td class="payment">
                      <h2 class="text-right">{{ totalCartTax.toFixed(2) }}</h2>
                    </td>
                  </tr>
                  <tr v-if="netAmountCalculate">
                    ...
                    <td class="Rate" colspan="2"><h2>Net Amount</h2></td>
                    <td class="payment">
                      <h2 class="text-right">{{ Number(netAmountCalculate).toFixed(2) }}</h2>
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div id=" ">
                ...
                <table>
                  ...
                  <tr class="service borderBottom" v-if="(netAmountCalculate - totalCollections) > 0">
                    ...
                    <td class="text-right">{{ Number(netAmountCalculate - totalCollections).toFixed(2) }}</td>
                  </tr>
                  <tr class="service borderBottom" v-else>
                    <td>
                      Return
                    </td>
                    <td class="text-right">{{ Math.abs(Number(netAmountCalculate - totalCollections)).toFixed(2) }}</td>
                  </tr>
                </table>
              </div>
              <!-- <div id="legalcopy">
        ...
        <div class="modal-body inv-perview" id="printMe">
          <div id="invoice-POS" v-if="invoice_info">
            ...
            <div id="mid" class="fnt10">
              <div class="info">
                <p class="text-left" style="font-size: 14px">
                  Patient : {{ invoice_info.customer_name }}<br />
            ...
            <div id="bot" class="fnt10">
              <div id="table">
                <table  style="width: 100% !important;">
                  ...
                  <tr class=" " v-if="invoice_info.customer_group_discount" >
                    <td></td>
                    <td></td> 
                    <td class="Rate" colspan="3"> Customer Discount </td>
                    <td class="payment text-right" style="text-align: right" > {{ Number(invoice_info.customer_group_discount).toFixed(2) }} 
                    </td>
                  </tr>
                  <tr class=" " v-if="invoice_info.order_discount || invoice_info.sales_items_sum_discount">
                    <td></td>
                    <td></td>
                    <td class="Rate" colspan="3">Discount</td>
                    <td class="payment text-right" style="text-align: right"> {{ Number(invoice_info.order_discount_value + invoice_info.sales_items_sum_discount).toFixed(2) }} </td>
                  </tr>
                  <tr
              ...
              <div id="legalcopy">
                <h5 class="text-left">In words: <span class="amount-in-word">{{  invoice_info ? inWords(invoice_info.grand_total) : inWords(0) }}</span> </h5>
              </div>
              ...
              <div id="legalcopy">
                <h2 class="text-center borderBottom">Note:</h2>
                <p>Please Exchange Any Product Within 24 Hours</p>
              </div>
    ...
    <Modal @close="barcodeReaderModal()" :modalActive="barcodeReaderModalActive">
...
export default {
  ...
  data() {
    return {
      ...
      returnInfo: "",
      return_replace: [],
      // sale_return_info: { return_amount: "", return_reason: "", cost_center_id: null },
  ...
  methods: {
    ...
    fetchCostCenters()
    {
        ...
        .then((res) => {
            this.cost_centers = res.data.data.cost_centers;
            this.costCenterOptions = res.data.data.cost_center_options;
        })
        .catch((err) => { 
    ...
    handleSubmit: function () { 
      ...
      // this.pform.cost_center_id = this.form.cost_center_id;
      this.pform.order_discount = this.form.order_discount;
      this.pform.customer_id = this.form.customer_id;
      this.pform.customer_name = (this.form.customer_id == 1) ? this.form.default_customer_name : "";
      ...
      if (this.editMode) {
        var postEvent = axios.put(
          ...
          this.apiUrl + "/sales-with-account-transaction/" + this.form.id,
          this.pform,
          this.headerjson
        );
      } else {
        var postEvent = axios.post(
          // this.apiUrl + "/sales",
          this.apiUrl + "/sales-with-account-transaction",
          this.pform,
          this.headerjson
        );
      }
    ...
    itemDiscountPercent: function(item, index){ 
      ...
      this.$store.getters.cartItems[index].item_discount = order_discount;
    },

    allItemDiscountPercent: function() { 
      var data_count = this.$store.getters.cartItems.length;
      for(var i = 0; i < data_count; i++){
        this.$store.getters.cartItems[i].discount_percent = this.items_discount_percent;
        this.itemDiscountPercent(this.$store.getters.cartItems[i], i);
      }
    },
  ...
  computed: {
    ...
    totalItemNetValue:  function(){
      return this.$store.getters.cartItems.reduce(function (total, item) {
        let results;
        if(item.uom == 5){
          results = parseFloat( item.mrp_price * item.weight - (item.discount * item.weight)).toFixed(2)
        }else{
          results = parseFloat( item.mrp_price * item.quantity - (item.discount * item.quantity)).toFixed(2)
        } 
