                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-3">
                                    <div class="mt-3">
                                        <button type="submit" class="btn btn-primary  " :disabled="disabled" @click="filterCashBookReport()">
                    ...
                    <Modal @close="toggleModal()"  >
                        <div class="modal-content scrollbar-width-thin orderPreview" >
                            <div class="modal-header"> 
                                ...
                                <h3 style="width: 100%">Cash Book</h3>
                            </div>
...
export default {
    ...
    methods: { 
        ...
        fetchCashBookReport() { 
            ...
            axios.post(this.apiUrl+'/reports/cash-book-report', data, this.headerjson)
            .then((res) => {
