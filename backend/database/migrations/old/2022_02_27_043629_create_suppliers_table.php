...
class CreateSuppliersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('suppliers', function (Blueprint $table) {
            ...
            $table->boolean('outlet_receive')->default(0)->comment('0=No|1=Yes');
            // Account Ledger
            $table->unsignedBigInteger('payable_ledger_id');
            $table->unsignedBigInteger('discount_ledger_id');
            $table->unsignedBigInteger('advance_ledger_id');
            // Account Ledger
