                        ...
                        <div class="row" >
                            <div class="col-md-2">
                                <div class="">
                                    ...
                                    <select class="form-control" id="outlet_id" v-model="tableData.outlet_id">
...
export default {
    ...
    methods: { 
        ...
        fetchStockData() { 
            axios.get(this.apiUrl+'/stocks/stock_management')
            .then((res) => {
        ...
        submitAdjustStock: function(e) { 
            ...
            var postEvent = axios.post(this.apiUrl+'/stocks/stockAdjustment', formData, this.headers);         
        ...
        fetchItems(url = this.apiUrl+'/stocks/stock_management') {
            this.tableData.draw++;
