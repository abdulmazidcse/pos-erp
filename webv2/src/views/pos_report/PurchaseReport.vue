                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="mt-3">
                                        <button type="submit" class="btn-sm btn btn-primary" :disabled="disabled" @click="filterPurchaseReport()">
                                ...
                                <div class="col-md-2">
                                    <div class="mt-3">
                                        ...
                                        <a href="javascript:void(0);" style="margin-left: 15px;" class="btn-sm btn btn-primary   " @click.prevent="printItem(item)"  ><i class="mdi mdi-printer-outline me-1"></i></a>
                                ...
                                <template #header > 
                                    <div class="tableFilters" style="margin-bottom: 10px;">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="control" style="float: left;">
                                                    ...
                                                    <div class="select" style="float: left;">
                                                        <select class="form-select" v-model="tableData.length" @change="getPurchaseReport()"> 
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" style="float: right;" v-model="tableData.search" placeholder="Search..." @input="getPurchaseReport()">
                                            </div>
                                        </div>
                                    </div>   
                                </template> 
                                <template #body > 
                                    <tbody v-if="items.length > 0">
                                        <tr class="border" v-for="(item, i) in items" :key="i">
                                            ...
                                            <td class="text-right">{{ item.net_amount - item.paid_amount }} </td> -->
...
export default {
    ...
    methods: { 
        ...
        // For Pagination 
        getPurchaseReport(url = this.apiUrl+'/reports/purchase-report') {
            this.tableData.draw++;
        ...
        setPage(data){  
            this.getPurchaseReport(data.url); 
        },
        ...
        async exportToExcel() { 
            ...
            try {
                const response = await axios.get(`${this.apiUrl}/reports/purchase-report-excel-export${query}`, {
