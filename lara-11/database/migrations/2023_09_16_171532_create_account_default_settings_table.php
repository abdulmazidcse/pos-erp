...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('account_default_settings', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('customer_receivable_account_type');
            $table->unsignedBigInteger('inventory_account');
            $table->unsignedBigInteger('cogs_account');
            $table->unsignedBigInteger('inventory_damage_account');
            ...
            $table->unsignedBigInteger('credit_sales_account');
